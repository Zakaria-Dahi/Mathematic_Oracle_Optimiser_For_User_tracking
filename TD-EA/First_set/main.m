...
global fitness_eval 
       fitness_eval = [175000 175000 175000 175000 175000 175000 175000 175000 175000 175000 175000 175000 35000 35000 35000 175000 175000 175000 175000 175000 175000 175000 175000 175000 175000 175000 175000];
...
if LS_loop == 1
    allowed = individual - 1;
    population = round(rand(allowed,Dimension));
    population = [gbest;population];
...
offsprings = HUX_crossover(Pre_HUX,individual,HUX_distance,pcr);
[rows_off,cols_off] = size(offsprings);
if rows_off > individual
    rows_off = individual;
    offsprings = offsprings(1:individual,:);
end
...
if isequal(test,ones(1,indiv)) == 1
