...
% ------------------------------------------------------------------
if isequal(c11,zeros(1,Dimension)) == 1 
    c11(randi(Dimension)) = 1;
end
if isequal(c12,zeros(1,Dimension)) == 1 
    c12(randi(Dimension)) = 1;
end
...
% ------------------------------------------------------------------
if isequal(c21,zeros(1,Dimension)) == 1 
    c21(randi(Dimension)) = 1;
end
if isequal(c22,zeros(1,Dimension)) == 1 
    c22(randi(Dimension)) = 1;
end
